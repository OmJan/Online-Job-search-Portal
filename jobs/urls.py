...
urlpatterns = lang_patterns + [
    ...
    path("templates/load-builder/<id>", load_builder,
         name="resume-cv.load.builder"),
    path("templates/update-builder/<id>", csrf_exempt(update_builder),
         name="resume-cv.update.builder"),
    path(
        "api/",
        include(
            [
    ...
    path("sitemap.xml/", sitemap, {"sitemaps": dict(Sitemaps())},
